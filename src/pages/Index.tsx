            ...
            <div className="max-w-4xl mx-auto mb-20">
              <Card className="border-2 shadow-xl bg-gradient-to-br from-white to-gray-50">
                ...
                <CardContent className="space-y-4 text-gray-700 leading-relaxed text-lg">
                  <p>
                    Партия "Мнение Камня" основана в 2024 году группой людей, которые устали от советов Толика. 
                    Последней каплей стал его совет "вложиться в NFT обезьян" — после этого мы поняли, что пора действовать.
                  </p>
                  <p>
                    Мы верим, что даже самый обычный булыжник с дороги принимает решения лучше, чем Толик. 
